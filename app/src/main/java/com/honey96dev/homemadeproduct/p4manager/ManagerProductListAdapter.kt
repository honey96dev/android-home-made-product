...
(internal var mContext: Context, internal var mDataset: ArrayList<ManagerProduct>) : RecyclerView.Adapter<ManagerProductListAdapter.ManagerProductViewHolder>() {

    // Dataitem
    class ManagerProduct(var id: String, storeID: String, var name: String, var description: String,
    ...
    class ManagerProductViewHolder(root: View) : RecyclerView.ViewHolder(root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ManagerProductViewHolder {
        // create a new view
        val root = LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_manager_product_item, parent, false)

        return ManagerProductViewHolder(root)
    }

    // Replace the contents of a view (invoked by the layout manager)
    override fun onBindViewHolder(holder: ManagerProductViewHolder, position: Int) {
